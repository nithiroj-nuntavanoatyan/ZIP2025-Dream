...
@Component({
  ...
  styleUrl: './pokemondetailpage.component.scss'
})
export class PokemondetailpageComponent {
  pokemonId = [
    { id: '1', name: 'Pikachu ', firsttype: 'Electric', secondtype: '', imgsrc: 'https://www.pokemon.com/static-assets/content-assets/cms2/img/pokedex/full/025.png' },
  ...
  constructor(private route: ActivatedRoute) {
    ...
    this.pokemonid = this.pokemonId.find(p => p.id === id);
  }
